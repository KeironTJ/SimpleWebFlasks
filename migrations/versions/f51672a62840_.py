...
Revision ID: f51672a62840
Revises: 
Create Date: 2024-07-09 22:39:52.455021
...
def upgrade():
    ...
    sa.Column('base_xp_required', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['inventory_type_id'], ['test_game_inventory_types.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('base_building_cash_required', sa.Float(), nullable=True),
    sa.Column('base_building_level_required', sa.Integer(), nullable=True),
    sa.Column('cash_per_hour', sa.Float(), nullable=True),
    ...
    op.create_table('test_game_inventory_user',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('game_id', sa.Integer(), nullable=True),
    ...
    sa.Column('quantity', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['inventory_id'], ['test_game_inventory_user.id'], ),
    sa.ForeignKeyConstraint(['item_id'], ['test_game_items.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    ...
    op.drop_table('test_game_inventory_user')
